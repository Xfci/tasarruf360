import { Image, Text, View, TouchableOpacity, Dimensions, StatusBar,Linking } from 'react-native'
            ...
            <ScrollView>
                ...
                <View style={styles.porfileContainer}>
                    <View style={[styles.part, { flex: 0.75 }]}>
                        {
                            data[1] == 'google' ?
                                <Image style={{ width: 100, height: 100, borderRadius: 100, alignSelf: 'center' }} source={{ uri: data[3] }} /> :
                ...
                <View style={styles.profileContent}>
                    {
                        settingType == '' ?
                            <View>
                                <TouchableOpacity style={[styles.profileButton, , { paddingTop: 0 }]} onPress={() => Linking.openSettings()}>
